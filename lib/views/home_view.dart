...
import 'package:photogallerymobileapp/controllers/post_controller.dart';
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              TextButton.icon(
                                onPressed: () async {
                                  final imp.XFile? xFile = await _imagePicker.pickImage(
                              ...
                              TextButton.icon(
                                onPressed: () async {
                                  final imp.XFile? xFile = await _imagePicker.pickImage(source: imp.ImageSource.gallery);
              ...
              return ListView.separated(
                itemBuilder: (context, index) {
                  ...
                  return PostCardWidget(
                    ...
                    profilePic: snapshot.data!.docs[index].data()['profilePic'],
                    postImage: snapshot.data!.docs[index].data()['image_Url'],
                    likeCount: snapshot.data!.docs[index].data()['likesCount'],
                    commentCount: snapshot.data!.docs[index].data()['commentCount'],
                  );
                },
      ...
      child: Column(
        children: [
          ListTile(
            ...
            title: Text(
              name,
              style: Theme.of(context).textTheme.bodyText1!.copyWith(fontWeight: FontWeight.w500, fontSize: 21),
            ),
            subtitle: Row(
              children: [
                const Icon(
